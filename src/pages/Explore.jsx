...
export default function Explore() {
  ...
  return (
    <motion.div 
      ...
      className="max-w-7xl mx-auto px-6 py-12 pt-32" // Adicionado padding top para não bater na navbar
    >
        ...
        <div className="flex w-full lg:w-auto gap-4">
          <div className="relative flex-1 lg:w-80">
            ...
            <input 
              ...
              className="w-full pl-12 pr-6 py-4 bg-white border border-slate-200 rounded-2xl font-bold focus:ring-2 focus:ring-indigo-600 outline-none"
              value={busca}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {servicosFiltrados.map((s, index) => (
            <motion.div 
              ...
              whileHover={{ y: -10, transition: { duration: 0.2 } }} // Card sobe no hover
              className="group glass-card overflow-hidden bg-white rounded-[2.5rem] shadow-lg hover:shadow-2xl transition-all"
            >
